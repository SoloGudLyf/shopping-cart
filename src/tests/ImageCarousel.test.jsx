...
const imageCarousel = (
  <ImageCarousel
    imagesArr={[
      {
        src: "src/components/image-carousel/image-carousel/images/rebar.webp",
        alt: "Rebar",
      },
      {
        src: "src/components/image-carousel/image-carousel/images/timber.webp",
        alt: "timber",
      },
      {
        src: "src/components/image-carousel/image-carousel/images/masonry.webp",
        alt: "masonry",
      },
      {
        src: "src/components/image-carousel/image-carousel/images/roofing.webp",
